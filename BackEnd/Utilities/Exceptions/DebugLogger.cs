    ...
    public class DebugLogger
    {
        ...
        private void GenerateErrorMessage()
        {
            StringBuilder stringBuilder = new StringBuilder()
                ...
                .AppendLine($"URL Params: {(UrlParams != null ? UrlParams : "None")}")
                .AppendLine($"Request Body:{(RequestBody != null ? RequestBody : "None")}")
                .AppendLine()
                .AppendLine($"Description: {(Description != null ? Description : "")}")
                .AppendLine()
