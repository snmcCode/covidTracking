...
namespace Admin.Services
{
    public class EventsService
    {
        ...
        public static async Task<List<StatusInfo>> GetStatuses(string url, string targetResource, ILogger logger)
        {
            ...
            try
            {
                ...
                if (result.IsSuccessStatusCode)
                {
                    ...
                    try
                    {
                        List<StatusInfo> statuses = JsonConvert.DeserializeObject<List<StatusInfo>>(data);
                        return statuses;
                    }
                    catch (Exception e)
                    {
