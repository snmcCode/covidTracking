...
SELECT e.Id as 'Id' ,o.Name as 'Organization',o.Id as 'OrgId',e.Name as 'Event',CAST(e.DATETIME as DATETime2) as 'EventDate',dbo.GetEventRegistrationCount(e.Id) as 'BookingCount' ,
e.Groupid
